      ...
      <div className="max-w-5xl mx-auto px-6 pt-12 space-y-12">
        ...
        <section className="text-center space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-3xl mx-auto mt-8">
            <div className="bg-white p-8 rounded-3xl shadow-sm border border-slate-100 flex flex-col items-center space-y-2">
              ...
              >
                ...
                <CardContent className="space-y-4">
                  <div className="flex items-baseline gap-1">
                    ...
                    <span className="text-sm text-slate-500">/mo saved</span>
                  </div>
        ...
        {/* AI Summary Section */}
        <section className="relative bg-white p-8 md:p-12 rounded-3xl shadow-sm border border-slate-100 overflow-hidden">
